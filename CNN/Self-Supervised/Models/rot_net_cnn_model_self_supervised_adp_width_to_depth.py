...
# Load baseline
BASE_PATH = Path(__file__).with_name("rot_net_cnn_model_self_supervised.py").resolve()
...
def main():
    ...
    # Initialize Logger
    logger = ContinuousLogger(Path("results_adp_rot_net_cnn_model_self_supervised"), "rot_net_cnn_model_self_supervised", args.adp_mode)
