...
# Load baseline
BASE_PATH = Path(__file__).with_name("vicreg_cnn_model_self_supervised.py").resolve()
...
def main():
    ...
    # Initialize Logger
    logger = ContinuousLogger(Path("results_adp_vicreg_cnn_model_self_supervised"), "vicreg_cnn_model_self_supervised", args.adp_mode)
