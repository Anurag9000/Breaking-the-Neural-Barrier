...
# Load baseline
BASE_PATH = Path(__file__).with_name("barlow_twins_cnn_model_self_supervised.py").resolve()
...
def main():
    ...
    # Initialize Logger
    logger = ContinuousLogger(Path("results_adp_barlow"), "barlow", args.adp_mode)
