...
# Load baseline
BASE_PATH = Path(__file__).with_name("byol_cnn_model_self_supervised.py").resolve()
...
def main():
    ...
    # Initialize Logger
    logger = ContinuousLogger(Path("results_adp_byol_cnn_model_self_supervised"), "byol_cnn_model_self_supervised", args.adp_mode)
