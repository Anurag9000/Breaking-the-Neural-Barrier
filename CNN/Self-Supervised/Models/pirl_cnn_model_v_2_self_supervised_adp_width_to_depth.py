...
# Load baseline
BASE_PATH = Path(__file__).with_name("pirl_cnn_model_v_2_self_supervised.py").resolve()
...
def main():
    ...
    # Initialize Logger
    logger = ContinuousLogger(Path("results_adp_pirl_cnn_model_v_2_self_supervised"), "pirl_cnn_model_v_2_self_supervised", args.adp_mode)
