...
# Load baseline
BASE_PATH = Path(__file__).with_name("sw_av_cnn_model_self_supervised.py").resolve()
...
def main():
    ...
    # Initialize Logger
    logger = ContinuousLogger(Path("results_adp_sw_av_cnn_model_self_supervised"), "sw_av_cnn_model_self_supervised", args.adp_mode)
