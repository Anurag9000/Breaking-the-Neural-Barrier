...
# Load baseline
BASE_PATH = Path(__file__).with_name("sim_clr_cnn_model_self_supervised.py").resolve()
...
def main():
    ...
    # Initialize Logger
    logger = ContinuousLogger(Path("results_adp_sim_clr_cnn_model_self_supervised"), "sim_clr_cnn_model_self_supervised", args.adp_mode)
