"""
Runner for MobileNet V3 (CIFAR) — single-model supervised.
Supports versions {small, large}, width multiplier, and dropout. Standard early-stopping loop,
...
from CNN_MobileNetV3 import make_mobilenet_v3_cifar
...
def train(args):
    ...
    torch.save({
        "model": f"MobileNetV3-{args.version}(CIFAR, width_mult={args.width_mult}, dropout={args.dropout})",
...
def build_argparser():
    ...
    p.add_argument("--save_path", type=str, default="./checkpoints/mobilenetv3_small_cifar10.pth")
