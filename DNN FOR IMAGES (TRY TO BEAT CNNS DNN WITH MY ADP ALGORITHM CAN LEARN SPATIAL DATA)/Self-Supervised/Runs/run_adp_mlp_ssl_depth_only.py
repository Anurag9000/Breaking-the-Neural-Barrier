...
from adp_mlp_ssl_depth_only import AdaptiveMLPSSL, build_data, adp_search_depth_only
...
def main():
    ...
    p.add_argument("--trials_depth", type=int, default=5)
    ...
    best_val = adp_search_depth_only(model, trl, val, device,
    ...
    path = os.path.join("checkpoints", f"adp_mlp_ssl_depth_only_{args.dataset}.pt")
