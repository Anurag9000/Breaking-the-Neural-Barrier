...
from adp_mlp_ssl_width_only import AdaptiveMLPSSL, build_data, adp_search_width_only
...
def main():
    ...
    path = os.path.join("checkpoints", f"adp_mlp_ssl_width_only_{args.dataset}.pt")
