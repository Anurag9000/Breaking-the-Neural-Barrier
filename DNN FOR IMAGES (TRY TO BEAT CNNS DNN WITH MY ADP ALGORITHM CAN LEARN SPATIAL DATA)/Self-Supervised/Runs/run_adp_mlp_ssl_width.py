...
from adp_mlp_ssl_width import AdaptiveMLPSSL, build_data, adp_search_width_then_depth
...
def main():
    ...
    best_val = adp_search_width_then_depth(model, trl, val, device,
    ...
    path = os.path.join("checkpoints", f"adp_mlp_ssl_width_{args.dataset}.pt")
