...
from adp_mlp_ssl_alt_depth import AdaptiveMLPSSL, build_data, adp_search_alternating_depth_first
...
def main():
    ...
    best_val = adp_search_alternating_depth_first(model, trl, val, device,
    ...
    path = os.path.join("checkpoints", f"adp_mlp_ssl_alt_depth_{args.dataset}.pt")
