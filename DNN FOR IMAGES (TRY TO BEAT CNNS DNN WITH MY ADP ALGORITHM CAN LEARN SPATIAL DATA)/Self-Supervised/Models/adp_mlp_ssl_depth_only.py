...
def adp_search_depth_only(model: AdaptiveMLPSSL, train_loader, val_loader, device,
                          trials_depth: int, epochs: int, lr: float, patience: int,
                          delta: float, max_neurons: int=None, max_depth: int=None, max_width: int=None,
