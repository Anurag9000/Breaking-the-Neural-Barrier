...
from adp_mlp_ae_alt_depth import AdaptiveMLPAE, adp_search_alternating_depth_first
...
def main():
    ...
    path = os.path.join("checkpoints", f"adp_mlp_ae_alt_depth_{args.dataset}.pt")
