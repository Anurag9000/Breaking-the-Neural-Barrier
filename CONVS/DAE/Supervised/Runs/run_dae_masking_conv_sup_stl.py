...
from ..Models.dae_masking_conv_sup_stl import SupDAEMaskingConv, sup_dae_total_neurons
...
def main() -> None:
    p = argparse.ArgumentParser(description="Supervised masking Conv DAE encoder + classifier")
    # Data / IO
    p.add_argument("--dataset", type=str, default="cifar10", choices=["cifar10", "cifar100"])
    p.add_argument("--data_dir", type=str, default="./data")
    p.add_argument("--out_dir", type=str, default="./Runs/dae_masking_conv_sup")
    ...
    try:
        for epoch in range(1, args.epochs + 1):
            ...
            val_acc = eval_accuracy(model, val_loader, device, mask_prob=args.mask_prob)
    ...
    test_acc = eval_accuracy(model, test_loader, device, mask_prob=args.mask_prob)
