...
def main() -> None:
    p = argparse.ArgumentParser(description="Gaussian Conv DAE STL training on CIFAR")
    # Data / IO
    p.add_argument("--dataset", type=str, default="cifar10", choices=["cifar10", "cifar100"])
    p.add_argument("--data_dir", type=str, default="./data")
    p.add_argument("--out_dir", type=str, default="./Runs/dae_gaussian_conv_stl")
    ...
    # Final evaluation is on val set (no separate test here)
    report = {
        "dataset": args.dataset,
        "width": args.width,
        "depth": args.depth,
