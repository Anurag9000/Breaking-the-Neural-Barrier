...
from ..Models.dae_unet_conv_stl import DAEUNetConv, dae_total_neurons
...
def main() -> None:
    ...
    p.add_argument("--results-dir", type=str, default="results_dae_unet_conv_cifar")
    p.add_argument("--width", type=int, default=64)
    p.add_argument("--depth", type=int, default=4)
    p.add_argument("--noise-std", type=float, default=0.1)
    p.add_argument("--batch-size", type=int, default=512)
    p.add_argument("--num-workers", type=int, default=0)
    p.add_argument("--epochs", type=int, default=100_000_000_000_000_000)
    ...
    model = DAEUNetConv(in_channels=3, width=args.width, depth=args.depth).to(device)
