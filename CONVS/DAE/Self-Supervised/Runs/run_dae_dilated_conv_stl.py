...
from ..Models.dae_dilated_conv_stl import DAEDilatedConv, dae_total_neurons
...
def main() -> None:
    p = argparse.ArgumentParser(description="Dilated Conv DAE STL training on CIFAR")
    p.add_argument("--dataset", type=str, default="cifar10", choices=["cifar10", "cifar100"])
    p.add_argument("--data_dir", type=str, default="./data")
    p.add_argument("--out_dir", type=str, default="./Runs/dae_dilated_conv_stl")
