...
from ..Models.dae_masking_conv_stl import DAEMaskingConv, dae_total_neurons
...
def train_one_epoch(
    ...
    for xb, _ in loader:
        ...
        xb_noisy = apply_mask_noise(xb, mask_prob)
...
def main() -> None:
    p = argparse.ArgumentParser(description="Masking Conv DAE STL training on CIFAR")
    p.add_argument("--dataset", type=str, default="cifar10", choices=["cifar10", "cifar100"])
    p.add_argument("--data_dir", type=str, default="./data")
    p.add_argument("--out_dir", type=str, default="./Runs/dae_masking_conv_stl")
