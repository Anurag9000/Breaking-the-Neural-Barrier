...
from vae_cvae import CVAE, CVAEConfig
...
def main(args):
    ...
    cfg = CVAEConfig(width=args.width, latent_dim=args.latent, num_classes=10, emb_dim=args.emb)
    ...
    if best_state:
        ...
        torch.save(best_state, os.path.join(args.out,'vae_cvae_cifar10.pth'))
        with open(os.path.join(args.out,'vae_cvae_metrics.json'),'w') as f:
