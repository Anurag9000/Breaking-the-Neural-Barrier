"""
Runner for Darknet-53 (CIFAR) — single-model supervised.
...
from CNN_Darknet53 import make_darknet53_cifar
...
def train(args):
    ...
    # Model/opt/loss
    model = make_darknet53_cifar(num_classes=num_classes, in_channels=3).to(device)
...
def build_argparser():
    p = argparse.ArgumentParser(description="Train Darknet-53 (CIFAR) with early stopping (single-model).")
    ...
    p.add_argument("--save_path", type=str, default="./checkpoints/darknet53_cifar10.pth")
