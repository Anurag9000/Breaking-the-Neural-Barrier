...
# -----------------------------------------------------------------------------
# AE_ROBUST_STL: Convolutional autoencoder (same architecture family as AE_STL)
# for robust reconstruction with losses defined in the runner (Huber by default).
# -----------------------------------------------------------------------------
...
class AE_ROBUST_STL(nn.Module):
    ...
    Args:
      ...
      pool_after: 1-based indices where 2x2 MaxPool is applied and mirrored in decoder
    """
...
def ae_robust_total_neurons(width: int, depth: int) -> int:
