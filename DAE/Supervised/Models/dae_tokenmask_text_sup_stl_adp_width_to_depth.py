...
_spec = importlib.util.spec_from_file_location("dae_tokenmask_text_stl_adp_width_to_depth", BASE_PATH)
...
_base_spec = importlib.util.spec_from_file_location("dae_tokenmask_text_stl", BASE_MODEL_PATH)
