...
from ..Models.dae_ladder_vae_conv_stl import DAELadderVAEConv, ladder_vae_total_neurons
...
def main() -> None:
    p = argparse.ArgumentParser(description="Ladder VAE Conv DAE STL on CIFAR")
    p.add_argument("--dataset", type=str, default="cifar10", choices=["cifar10", "cifar100"])
    p.add_argument("--data_dir", type=str, default="./data")
    p.add_argument("--out_dir", type=str, default="./runs/dae_ladder_vae_conv_stl")
    ...
    model = DAELadderVAEConv(in_channels=3, width=args.width, depth=args.depth, latent_dim=args.latent_dim).to(device)
    ...
    best_epoch = -1
    epochs_no_improve = 0
    neurons = ladder_vae_total_neurons(args.width, args.depth, args.latent_dim)
