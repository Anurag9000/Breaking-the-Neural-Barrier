...
def train_one_epoch(
    ...
    """
    Noise2Noise objective: given clean x, sample two noisy versions x1,x2,
    feed x1 and regress to x2.
    """
    model.train()
    mse = nn.MSELoss()
    total, n = 0.0, 0
    for xb, _ in loader:
        ...
        x1 = add_gaussian_noise(xb, noise_std)
        x2 = add_gaussian_noise(xb, noise_std)
...
def main() -> None:
    p = argparse.ArgumentParser(description="Noise2Noise Conv DAE STL on CIFAR")
    p.add_argument("--dataset", type=str, default="cifar10", choices=["cifar10", "cifar100"])
    p.add_argument("--data_dir", type=str, default="./data")
    p.add_argument("--out_dir", type=str, default="./runs/dae_n2n_conv_stl")
