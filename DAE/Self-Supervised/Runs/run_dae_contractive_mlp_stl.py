...
from ..Models.dae_contractive_mlp_stl import DAEContractiveMLP, dae_total_neurons
...
def contractive_penalty(model: DAEContractiveMLP) -> torch.Tensor:
    """
    Simple contractive-style penalty: sum of Frobenius norms of encoder
    weight matrices.
    """
    total = 0.0
...
def main() -> None:
    p = argparse.ArgumentParser(description="Contractive MLP DAE STL on CIFAR")
    p.add_argument("--dataset", type=str, default="cifar10", choices=["cifar10", "cifar100"])
    p.add_argument("--data_dir", type=str, default="./data")
    p.add_argument("--out_dir", type=str, default="./runs/dae_contractive_mlp_stl")
    ...
    p.add_argument("--contractive_lambda", type=float, default=1e-4)
