...
class DAERobustMLP(nn.Module):
    """
    Fully-connected denoising autoencoder with a robust reconstruction loss
    (Huber). Architecture is a standard MLP encoder/decoder.
    """
...
__all__ = ["DAERobustMLP", "dae_total_neurons"]
