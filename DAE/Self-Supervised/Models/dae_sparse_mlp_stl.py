...
class DAESparseMLP(nn.Module):
    """
    Fully-connected denoising autoencoder with a sparsity-inducing penalty on
    the latent representation. Architecture is a standard MLP encoder/decoder.
    """
...
__all__ = ["DAESparseMLP", "dae_total_neurons"]
