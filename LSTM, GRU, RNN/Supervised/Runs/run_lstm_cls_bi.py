...
from lstm_cls_bi import BiLSTMClassifier, BiLSTMConfig
...
def main():
    ...
    model = BiLSTMClassifier(cfg).to(args.device)
    ...
    torch.save({"model_state": model.state_dict(), "config": cfg.__dict__, "test_loss": tl, "test_acc": ta}, os.path.join(args.outdir, "lstm_cls_bi.pt"))
