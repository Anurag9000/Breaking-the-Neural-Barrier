...
from RNN_GRU_Peephole import RNN_GRU_Peephole
...
def main():
    ...
    model = RNN_GRU_Peephole(input_dim=input_dim, hidden_size=args.hidden, num_layers=args.layers, num_classes=num_classes)
