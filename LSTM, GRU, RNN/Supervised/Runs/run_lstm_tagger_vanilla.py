...
def main():
    ...
    logger = ContinuousLogger(Path('results_run_lstm_tagger_vanilla'), 'run_lstm_tagger_vanilla', 'train')
    ...
    for epoch in range(1, args.max_epochs + 1):
        ...
        msg = f"Epoch {epoch:03d} | train_loss={tr_loss:.4f} | val_loss={val_loss:.4f} | val_tok_acc={val_tok_acc:.4f}"
