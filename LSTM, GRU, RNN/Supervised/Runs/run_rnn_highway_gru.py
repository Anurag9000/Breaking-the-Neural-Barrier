...
from RNN_HighwayGRU import RNN_HighwayGRU
...
def main():
    ...
    model = RNN_HighwayGRU(input_dim=input_dim, hidden_size=args.hidden, num_layers=args.layers, num_classes=num_classes)
