...
# Local imports
from adp_lstm import (
    TextLSTM, ADP_LSTM_Search, TrainCfg, SearchCfg, TensorTextDataset
)
...
def main():
    ...
    adp = ADP_LSTM_Search(model, train_cfg, search_cfg)
