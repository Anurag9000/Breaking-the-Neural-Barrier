...
def main():
    ...
    ap.add_argument("--ksz", type=int, default=2)
    ...
    model = RNN_QRNN(input_dim=input_dim, hidden_size=args.hidden, num_layers=args.layers, num_classes=num_classes, ksz=args.ksz)
