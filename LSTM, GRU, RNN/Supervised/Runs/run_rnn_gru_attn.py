...
from RNN_GRU_AttnHead import RNN_GRU_AttnHead
...
def main():
    ...
    model = RNN_GRU_AttnHead(input_dim=input_dim, hidden_size=args.hidden, num_layers=args.layers, num_classes=num_classes, heads=args.heads)
