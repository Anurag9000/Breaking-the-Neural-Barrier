...
from RNN_Vanilla_ReLU import RNN_Vanilla_ReLU
...
def main():
    ...
    model = RNN_Vanilla_ReLU(input_dim=96, hidden_size=args.hidden, num_layers=args.layers, num_classes=10)
