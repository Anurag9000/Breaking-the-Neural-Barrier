...
from RNN_GRU_ResNorm import RNN_GRU_ResNorm
...
def main():
    ...
    model = RNN_GRU_ResNorm(input_dim=input_dim, hidden_size=args.hidden, num_layers=args.layers, num_classes=num_classes)
