...
def main():
    ...
    torch.save({"model_state": model.state_dict(), "config": cfg.__dict__, "test_loss": tl, "test_acc": ta}, os.path.join(args.outdir, "lstm_cls_var_dropout.pt"))
