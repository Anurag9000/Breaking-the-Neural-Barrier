...
def main():
    ...
    ap.add_argument('--save', type=str, default='cpc_gru_best.pt')
    args = ap.parse_args()
    ...
    net = CPCGRU(args.D, args.hidden, args.proj, args.K, args.layers).to(device)
    ...
    logger = ContinuousLogger(Path('results_run_rnn_cpc'), 'run_rnn_cpc', 'train')
