...
from lstm_segment_instance_disc import (
    WhitespaceTokenizer,
    SegmentDataset,
    pad_views,
    LSTMEncoder,
...
if __name__ == "__main__":
    ...
    train_ds = SegmentDataset(train_ids, seg_len=args.seg_len, views=args.views, seed=args.seed)
    val_ds = SegmentDataset(val_ids, seg_len=args.seg_len, views=args.views, seed=args.seed)
    test_ds = SegmentDataset(test_ids, seg_len=args.seg_len, views=args.views, seed=args.seed)

    train_loader = DataLoader(train_ds, batch_size=args.batch_size, shuffle=True, drop_last=True, collate_fn=pad_views)
    val_loader = DataLoader(val_ds, batch_size=args.batch_size, shuffle=False, collate_fn=pad_views)
    test_loader = DataLoader(test_ds, batch_size=args.batch_size, shuffle=False, collate_fn=pad_views)
