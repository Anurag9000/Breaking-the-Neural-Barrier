...
from lstm_seq_autoencoder import WhitespaceTokenizer, SeqDataset, pad_collate, LSTMSeqAutoencoder, TrainConfig, train, evaluate
...
if __name__ == "__main__":
    ...
    model = LSTMSeqAutoencoder(vocab=len(tok.itos), emb_dim=cfg.emb_dim, hidden=cfg.hidden, enc_layers=cfg.enc_layers, dec_layers=cfg.dec_layers, dropout=cfg.dropout).to(device)
