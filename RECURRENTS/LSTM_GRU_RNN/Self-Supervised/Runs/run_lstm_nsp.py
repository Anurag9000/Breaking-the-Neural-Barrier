...
if __name__ == "__main__":
    ...
    train_ds = NSPDataset(tr, tok, max_len=args.max_len, seed=args.seed)
    val_ds = NSPDataset(va, tok, max_len=args.max_len, seed=args.seed)
    test_ds = NSPDataset(te, tok, max_len=args.max_len, seed=args.seed)
    ...
    model = LSTMNSP(vocab=len(tok.itos), emb_dim=cfg.emb_dim, hidden=cfg.hidden, layers=cfg.layers, dropout=cfg.dropout).to(device)
