...
from _common_treebank import make_treebank_loaders
...
def main():
    ...
    ap.add_argument("--outdir", type=str, default="results_treelstm")
    ...
    train_loader, val_loader, test_loader, vocab_size, num_classes = make_treebank_loaders(
    ...
    torch.save({"model_state": model.state_dict(), "config": cfg.__dict__, "test_loss": tl, "test_acc": ta}, os.path.join(args.outdir, "treelstm_childsum_cls.pt"))
