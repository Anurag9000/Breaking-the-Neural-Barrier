...
from RNN_GRU_Residual import RNN_GRU_Residual
...
def main():
    ...
    model = RNN_GRU_Residual(input_dim=input_dim, hidden_size=args.hidden, num_layers=args.layers, num_classes=num_classes)
