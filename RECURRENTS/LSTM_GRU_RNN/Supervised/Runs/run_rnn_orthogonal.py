...
from RNN_Orthogonal import RNN_Orthogonal
...
def main():
    ...
    model = RNN_Orthogonal(input_dim=input_dim, hidden_size=args.hidden, num_layers=args.layers, num_classes=num_classes)
