...
def train_with_patience(model: AE_ORTHO_STL, dl_train, dl_val, acfg: ADPConfig, device, history: list):
...
def main():
    ...
    print(f"[ADP Ortho AE STL] mode={args.adp_mode} best_val={best:.6f} width={model.width} depth={model.depth}")
