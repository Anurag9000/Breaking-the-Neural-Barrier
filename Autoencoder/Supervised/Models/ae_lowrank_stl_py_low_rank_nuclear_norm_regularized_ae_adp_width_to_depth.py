...
def train_with_patience(model: AE_LOWRANK_STL, dl_train, dl_val, acfg: ADPConfig, device):
...
def adp_search(model: AE_LOWRANK_STL, dl_train, dl_val, acfg: ADPConfig, device):
    def can_widen():
