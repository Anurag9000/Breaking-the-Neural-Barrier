...
from AE_GRAPH_STL import AE_GRAPH_STL, ae_graph_total_neurons

# -----------------------------------------------------------------------------
# Runner for AE_GRAPH_STL
# Converts CIFAR images to a P×P patch graph (ps=4 => P=8,N=64). Message passing
# over fixed 4-neighbor grid. Loss = MSE.
# -----------------------------------------------------------------------------
...
def main():
    ...
    report = {
        'dataset': args.dataset, 'patch_size': args.patch_size, 'dim': args.dim, 'depth': args.depth,
        'neurons_metric': ae_graph_total_neurons(args.dim, args.depth),
