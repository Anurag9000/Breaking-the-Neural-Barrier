...
from AE_STACKED_STL import AE_STACKED_STL, ae_stacked_total_neurons

# -----------------------------------------------------------------------------
# Runner for AE_STACKED_STL (deep stacked AE) with optional 1x1 mixing blocks.
# Loss = MSE; early stopping on validation set.
# -----------------------------------------------------------------------------
...
def main():
    ...
    p.add_argument('--out_dir', type=str, default='./runs/ae_stacked_stl')
    p.add_argument('--seed', type=int, default=1337)
    # Model
    p.add_argument('--width', type=int, default=64)
    p.add_argument('--depth', type=int, default=8)
    p.add_argument('--pool_after', type=str, default='2,4,6')
    p.add_argument('--mix_every', type=int, default=0)
    # Train
    ...
    model = AE_STACKED_STL(in_channels=3, width=args.width, depth=args.depth,
                           pool_after=pool_after, mix_every=args.mix_every).to(device)
    ...
    report = {
        ...
        'neurons_metric': ae_stacked_total_neurons(args.width, args.depth),
