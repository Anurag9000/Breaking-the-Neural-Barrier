...
from AE_TIED_STL import AE_TIED_STL, ae_tied_total_neurons

# -----------------------------------------------------------------------------
# Runner for AE_TIED_STL (tied-weights AE). Uses plain MSE reconstruction loss.
# -----------------------------------------------------------------------------
...
def main():
    ...
    p.add_argument('--out_dir', type=str, default='./runs/ae_tied_stl')
    p.add_argument('--seed', type=int, default=1337)
    # Model
    p.add_argument('--width', type=int, default=64)
    p.add_argument('--depth', type=int, default=4)
    p.add_argument('--pool_after', type=str, default='2')
    p.add_argument('--decoder_bn', action='store_true')
    # Train
    ...
    model = AE_TIED_STL(in_channels=3, width=args.width, depth=args.depth, pool_after=pool_after, decoder_bn=args.decoder_bn).to(device)
    ...
    report = {
        ...
        'neurons_metric': ae_tied_total_neurons(args.width, args.depth),
        'decoder_bn': bool(args.decoder_bn),
