...
from AE_STL import AE_STL, ae_total_neurons

# -----------------------------------------------------------------------------
# Runner for AE_STL (undercomplete conv autoencoder)
# Style mirrors run_cnn_stl.py: args, real-image loaders, early stopping by val loss,
# best checkpointing, and optional plot saves.
# -----------------------------------------------------------------------------

def build_dataloaders(dataset: str, data_dir: str, batch_size: int, num_workers: int, val_frac: float, seed: int) -> Tuple[DataLoader, DataLoader, DataLoader]:
    del dataset, seed
...
def main():
    ...
    p.add_argument('--out_dir', type=str, default='./runs/ae_stl')
    p.add_argument('--seed', type=int, default=1337)
    # Model
    p.add_argument('--width', type=int, default=64)
    p.add_argument('--depth', type=int, default=4)
    p.add_argument('--pool_after', type=str, default='2')  # comma-separated 1-based indices
    # Train
