...
def train_with_patience(model: DenoisingConvAE, dl_train, dl_val, acfg: ADPConfig, device):
...
def adp_search(model: DenoisingConvAE, dl_train, dl_val, acfg: ADPConfig, device):
    def can_widen():
