...
def train_with_patience(model: MaskedConvAE, dl_train, dl_val, acfg: ADPConfig, device):
...
def adp_search(model: MaskedConvAE, dl_train, dl_val, acfg: ADPConfig, device):
    def can_widen():
