...
def train_with_patience(model: InpaintingConvAE, dl_train, dl_val, acfg: ADPConfig, device):
...
def adp_search(model: InpaintingConvAE, dl_train, dl_val, acfg: ADPConfig, device):
    def can_widen():
