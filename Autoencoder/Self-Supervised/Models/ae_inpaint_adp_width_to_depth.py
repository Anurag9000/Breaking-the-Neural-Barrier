...
def rebuild_decoder(model: InpaintingConvAE, widths: List[int]):
...
def widen_all(model: InpaintingConvAE, ex_k: int, max_width: int):
    new_widths = []
    prev = model.in_ch
...
def append_depth(model: InpaintingConvAE):
