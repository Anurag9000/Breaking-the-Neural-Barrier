...
def train_with_patience(model: FeatureConvAE, dl_train, dl_val, acfg: ADPConfig, device):
...
def adp_search(model: FeatureConvAE, dl_train, dl_val, acfg: ADPConfig, device):
    def can_widen():
