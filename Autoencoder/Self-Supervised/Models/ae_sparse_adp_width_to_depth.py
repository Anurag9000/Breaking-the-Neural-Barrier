...
def train_with_patience(model: SparseConvAE, dl_train, dl_val, acfg: ADPConfig, device):
...
def adp_search(model: SparseConvAE, dl_train, dl_val, acfg: ADPConfig, device):
    def can_widen():
