...
from adp_pixel_vae import PixelVAEConfig, PixelVAE
...
def train(args):
    ...
    cfg=PixelVAEConfig(latent_dim=args.latent, width=args.width, depth=args.depth)
    model=PixelVAE(cfg).to(dev)
...
if __name__=='__main__':
    ...
    ap.add_argument('--out', type=str, default='./runs/pixel_vae')
