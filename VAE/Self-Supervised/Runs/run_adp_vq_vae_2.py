...
from adp_vq_vae2 import VQVAE2Config, VQVAE2
...
def train(args):
    ...
    cfg=VQVAE2Config(emb_dim_top=args.emb_top, emb_dim_bottom=args.emb_bottom, n_codes_top=args.codes_top, n_codes_bottom=args.codes_bottom, width=args.width)
    model=VQVAE2(cfg).to(dev)
...
if __name__=='__main__':
    ...
    ap.add_argument('--out', type=str, default='./runs/vq_vae2')
    ap.add_argument('--epochs', type=int, default=60)
    ap.add_argument('--batch', type=int, default=128)
    ap.add_argument('--lr', type=float, default=2e-3)
    ap.add_argument('--emb_top', type=int, default=64)
    ap.add_argument('--emb_bottom', type=int, default=64)
    ap.add_argument('--codes_top', type=int, default=256)
    ap.add_argument('--codes_bottom', type=int, default=512)
