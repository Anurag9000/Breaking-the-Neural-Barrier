...
from adp_nvae import NVAEConfig, NVAE
...
def train(args):
    ...
    cfg=NVAEConfig(z_levels=args.levels, z_dim=args.latent, width=args.width)
    model=NVAE(cfg).to(dev)
...
if __name__=='__main__':
    ...
    ap.add_argument('--out', type=str, default='./runs/nvae')
