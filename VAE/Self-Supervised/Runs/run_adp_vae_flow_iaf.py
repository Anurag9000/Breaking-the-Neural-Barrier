...
from adp_vae_flow_iaf import IAFVAEConfig, IAFVAE
...
def train(args):
    ...
    cfg=IAFVAEConfig(latent_dim=args.latent, n_flows=args.flows, hidden=args.hidden, width=args.width, depth=args.depth)
    model=IAFVAE(cfg).to(dev)
...
if __name__=='__main__':
    ...
    ap.add_argument('--out', type=str, default='./runs/vae_flow_iaf')
