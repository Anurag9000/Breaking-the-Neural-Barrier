...
from adp_vae_flow_radial import RadialFlowVAEConfig, RadialFlowVAE
...
def train(args):
    ...
    cfg=RadialFlowVAEConfig(latent_dim=args.latent, n_flows=args.flows, width=args.width, depth=args.depth)
    model=RadialFlowVAE(cfg).to(dev)
...
if __name__=='__main__':
    ...
    ap.add_argument('--out', type=str, default='./runs/vae_flow_radial')
