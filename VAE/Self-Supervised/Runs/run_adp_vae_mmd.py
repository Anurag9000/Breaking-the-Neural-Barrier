...
from adp_vae_mmd import MMDVAEConfig, MMDVAE
...
def train(args):
    ...
    cfg=MMDVAEConfig(latent_dim=args.latent, lambda_mmd=args.lambda_mmd, width=args.width, depth=args.depth)
    model=MMDVAE(cfg).to(dev)
...
if __name__=='__main__':
    ...
    ap.add_argument('--out', type=str, default='./runs/vae_mmd')
