...
from Autoencoder.ae_graph_stl.profiles import PROFILE_REGISTRY


class GraphExperiment(BaseAEExperiment):
    variant_name = "ae_graph_stl"
...
def main():
    ...
    GraphExperiment.model_builder = staticmethod(builder)
    GraphExperiment.variant_name = f"ae_graph_stl_{args.profile}"
    run_experiment(args, GraphExperiment)
