from Dyn_DNN4OPF.utils.pdl_constraints import objective 
...
def run_pipeline(cfg: dict) -> None:
    ...
    clip_layer = BoundedAct(bounds_low, bounds_high, torch.tensor(config["mask"], dtype=torch.bool, device = device), device = device)
