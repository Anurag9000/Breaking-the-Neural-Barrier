...
from Dyn_DNN4OPF.models.adp_den_2head_depth_only import ADP_DEN_2Head
...
DEFAULT_CONFIG = {
    ...
    "clip_test": False,
    # ─── Logging & checkpoints ───────────────────────────────────────────────
    "log_file": "train_adp_den_2head.csv",
    # ─── Data / model identifiers ────────────────────────────────────────────
    "model": "ADP-DEN-2HEAD-DEPTH-ONLY",
...
def run_pipeline(cfg: dict) -> None:
    ...
    # Instantiate & train
    model = ADP_DEN_2Head(SimpleNamespace(**config)).to(device)
