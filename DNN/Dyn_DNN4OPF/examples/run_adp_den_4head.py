...
from Dyn_DNN4OPF.models.adp_den_4head_expandtillplateuing import ADP_DEN_4Head
...
DEFAULT_CONFIG = {
    ...
    "model": "ADP-DEN-4HEAD-EXPANDTILLPLATEUING",
...
def run_pipeline(cfg: dict) -> None:
    ...
    # Instantiate & train
    model = ADP_DEN_4Head(SimpleNamespace(**config)).to(device)
