    ...
    def __init__(
        ...
        *,
        ...
        if use_bounds:
            ...
            bounds_low_t = torch.as_tensor(bounds_low, dtype=torch.float32, device=self.device)
            bounds_high_t = torch.as_tensor(bounds_high, dtype=torch.float32, device=self.device)
