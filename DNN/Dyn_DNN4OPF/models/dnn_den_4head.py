...
class DEN_4Heads(nn.Module):
    ...
    def __init__(self, cfg: SimpleNamespace):
        ...
        self.register_buffer("loss_thr",     torch.tensor(cfg.loss_thr,  dtype=torch.float32, device=d))
        self.register_buffer("spl_thr",      torch.tensor(cfg.spl_thr,   dtype=torch.float32, device=d))
        self.register_buffer("gl_lambda",    torch.tensor(cfg.gl_lambda, dtype=torch.float32, device=d))
        self.register_buffer("l1_lambda",    torch.tensor(cfg.l1_lambda, dtype=torch.float32, device=d))
        ...
        self.register_buffer("p_min", raw["p_min"].to(dtype=torch.float32))
        self.register_buffer("p_max", raw["p_max"].to(dtype=torch.float32))
        self.register_buffer("q_min", raw["q_min"].to(dtype=torch.float32))
        self.register_buffer("q_max", raw["q_max"].to(dtype=torch.float32))
        self.register_buffer("v_min", raw["v_min"].to(dtype=torch.float32))
        self.register_buffer("v_max", raw["v_max"].to(dtype=torch.float32))
