...
class PenaltyDEN_4head(DEN):
    ...
    def loss_fn(
        ...
        *,
        ...
        """
        Composite penalty loss with y_pred passthrough to avoid double forward.
        """
    ...
    def fit_task(
        ...
        *,
        ...
        """
        Uses self.loss_fn; validates on *pure MSE* with element-normalized aggregation.
        """
        device = self.device
        self._den_constraints = constraints
