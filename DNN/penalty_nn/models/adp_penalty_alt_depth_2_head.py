"""
Penalty‑ADP — Alternating (Depth→Width) — 2‑Head
- Train with penalty loss, select by **validation MSE**.
- DEPTH proposal first, then WIDTH.
- Two branches/heads (e.g., PQ and VM), concatenated output.
"""
...
# -------------------------------
# Controller (Alt‑Depth, MSE‑first)
# -------------------------------
class PENALTY_ADP_ALT_DEPTH_2Head:
    def __init__(self, in_dim: int, out_pq: int, out_vm: int, width: int = 64, depth: int = 1,
