"""
Drop‑in runner: **Penalty‑ADP Alternating (Width→Depth), 4‑Head**
...
from Dyn_DNN4OPF.models.adp_penalty_alt_width_4head import PENALTY_ADP_ALT_WIDTH_4Head
...
DEFAULT_CONFIG: Dict = {
    ...
    "patience": 20,
    "max_epochs": 500,
    "log_file": "penalty_adp_alt_width_4head.csv",
    "model": "PENALTY-ADP-ALT-WIDTH-4HEAD",
...
def run_pipeline(cfg: Dict) -> None:
    ...
    controller = PENALTY_ADP_ALT_WIDTH_4Head(
