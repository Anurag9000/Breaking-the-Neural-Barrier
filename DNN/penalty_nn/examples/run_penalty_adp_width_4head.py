...
from penalty_nn.models.penalty_adp_width_4head import PenaltyADPWidth_4Head
...
def run_pipeline(cfg: dict) -> None:
    ...
    # Instantiate & train
    model = PenaltyADPWidth_4Head(SimpleNamespace(**config)).to(device)
