"""
Drop‑in runner: **Penalty‑ADP Alternating (Depth→Width), 2‑Head**
...
from Dyn_DNN4OPF.models.adp_penalty_alt_depth_2head import PENALTY_ADP_ALT_DEPTH_2Head
...
DEFAULT_CONFIG: Dict = {
    ...
    "patience": 20,
    "max_epochs": 500,
    "log_file": "penalty_adp_alt_depth_2head.csv",
    "model": "PENALTY-ADP-ALT-DEPTH-2HEAD",
...
def run_pipeline(cfg: Dict) -> None:
    ...
    controller = PENALTY_ADP_ALT_DEPTH_2Head(
