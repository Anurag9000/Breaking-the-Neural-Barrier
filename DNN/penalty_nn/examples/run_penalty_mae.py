...
from penalty_nn.models.penalty_mae import PenaltyFullyConnectedNet
...
DEFAULT_CONFIG: Dict[str, Any] = {
    ...
    "lambda_loss":    1.0,        # λ₁ weight for baseline loss
    "lambda_eq":      1.0,        # λ₂ weight for equality residuals
    "lambda_ineq":    1.0,        # λ₃ weight for inequality violations
}
...
def run_pipeline(cfg: Dict[str, Any]) -> None:
    ...
    model = PenaltyFullyConnectedNet(
        input_dim=input_dim,
