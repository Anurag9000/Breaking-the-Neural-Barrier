...
from penalty_nn.models.penalty_adp_width_2head import PenaltyADPWidth_2Head
...
DEFAULT_CONFIG = {
    ...
    "clip_test": False,
    # ─── Logging & checkpoints ───────────────────────────────────────────────
    "log_file": "train_adp_width.csv",
    # ─── Data / model identifiers ────────────────────────────────────────────
    "model": "ADP-WIDTH-2HEAD-PENALTY",
...
def run_pipeline(cfg: dict) -> None:
    ...
    # Instantiate & train
    model = PenaltyADPWidth_2Head(SimpleNamespace(**config)).to(device)
