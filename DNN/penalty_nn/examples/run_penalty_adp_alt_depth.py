"""
Drop‑in runner: **Penalty‑ADP Alternating (Depth→Width), 1‑Head**
...
from Dyn_DNN4OPF.models.adp_penalty_alt_depth_1head import PENALTY_ADP_ALT_DEPTH_1Head
...
DEFAULT_CONFIG: Dict = {
    ...
    "patience": 20,
    "max_epochs": 500,
    "log_file": "penalty_adp_alt_depth.csv",
    "model": "PENALTY-ADP-ALT-DEPTH",
...
def _penalty_factory(eq: Dict, ineq: Dict, n_bus: int, n_gen: int) -> Callable[[torch.Tensor, torch.Tensor, torch.Tensor], torch.Tensor]:
    ...
    def penalty_fn(pred: torch.Tensor, xb: torch.Tensor, yb: torch.Tensor):
        ...
        ineq_term = ineq_p + ineq_q + ineq_v
        # Equality from network power injection
...
def run_pipeline(cfg: Dict) -> None:
    ...
    controller = PENALTY_ADP_ALT_DEPTH_1Head(
