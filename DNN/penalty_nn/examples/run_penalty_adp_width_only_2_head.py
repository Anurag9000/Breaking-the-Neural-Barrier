...
from penalty_nn.models.adp_penalty_2head_width_only import PenaltyADP_DEN_2Head
...
DEFAULT_CONFIG = {
    ...
    "model": "ADP-DEN-penalty-2head-width-only",
...
def run_pipeline(cfg: dict) -> None:
    ...
    # Instantiate & train
    model = PenaltyADP_DEN_2Head(SimpleNamespace(**config)).to(device)
    ...
    for task_id, (tr, va, te, cons) in enumerate(task_loaders, start=1):
        ...
        # Logging uses fc1 and branch widths
        try:
