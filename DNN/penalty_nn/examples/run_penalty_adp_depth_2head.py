...
from penalty_nn.models.penalty_adp_depth_2head import PenaltyADPDepth_2Head
...
def run_pipeline(cfg: dict) -> None:
    ...
    # Instantiate & train
    model = PenaltyADPDepth_2Head(SimpleNamespace(**config)).to(device)
