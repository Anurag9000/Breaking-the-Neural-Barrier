...
from penalty_nn.models.penalty_den_2head import PenaltyDEN
...
def run_pipeline(cfg: dict) -> None:
    ...
    logging.getLogger(__name__).info(f"Completed penalty DEN (2-head). Test loss: {test_loss:.6f}")
