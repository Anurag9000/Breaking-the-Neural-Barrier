...
from model_beit_sup import BEiT_Sup
...
def main():
    ...
    p.add_argument('--save',default='BEiT_Sup_best.pth')
    a=p.parse_args()
    ...
    m=BEiT_Sup(img_size=a.img_size, num_classes=nc, dim=a.dim, depth=a.depth, heads=a.heads).to(dev)
