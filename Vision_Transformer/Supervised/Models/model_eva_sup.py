...
# --------------------------------------------------
# EVA / EVA-02 (supervised fine-tuned encoder surrogate):
#  - Use a strong ViT-like encoder (larger dim, depth)
#  - Single-model supervised head; no EMA/distillation
# --------------------------------------------------

from model_vit import PatchEmbed, EncoderBlock

class EVA_Sup(nn.Module):
    def __init__(self, img_size=224, patch=14, num_classes=10, dim=1024, depth=24, heads=16, mlp_ratio=4.0):
        super().__init__()
