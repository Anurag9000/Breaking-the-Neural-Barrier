...
from vicregl_vit import VICRegLViT, VICRegLConfig
...
def main():
    ...
    cfg=VICRegLConfig(args.img,args.patch,args.dim,args.depth,args.heads,args.ratio,
                      args.proj_hidden,args.proj_out,args.w_inv,args.w_var,args.w_cov,args.w_local,args.gamma)
