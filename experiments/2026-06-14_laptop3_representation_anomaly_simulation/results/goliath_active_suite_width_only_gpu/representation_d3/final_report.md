...
## Task: representation
- Overall winner: `adp` via `ae_width_only` at `0.092910`
- Winner ADP architecture: `[154, 154, 154]`
- Winner STL architecture: `[154, 154, 154]`

| ADP variant | ADP best arch | ADP best val | STL refit arch | STL refit best val | Winner |
|---|---|---:|---|---:|---|
| ae_width_only | [154, 154, 154] | 0.092910 | [154, 154, 154] | 0.199482 | adp |
