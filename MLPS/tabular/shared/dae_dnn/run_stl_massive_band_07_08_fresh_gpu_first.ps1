# run_stl_massive_band_07_08_fresh_gpu_first.ps1
# GPU-first dual-gate scheduler for parameter-decade band 10^7-10^8 (fresh run).
...
& $PythonBin `
  ...
  --run-root MLPS/tabular/shared/dae_dnn/results/parammatched_decade_v1_fresh_v1_gpu_first_param_10pow07_08 `
