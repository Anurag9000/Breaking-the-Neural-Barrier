# run_stl_massive_band_09_10_pressure_resume_gpu_first.ps1
# GPU-first dual-gate pressure-resume for band 10^9-10^10.
...
& $PythonBin `
  ...
  --run-root MLPS/tabular/shared/dae_dnn/results/parammatched_decade_v1_param_10pow09_10 `
  ...
  --host-ram-pressure-limit-pct 95.0 --host-ram-resume-pct 90.0 `
