# run_stl_massive_band_07_08_pressure_resume_gpu_first.ps1
# GPU-first dual-gate pressure-resume for band 10^7-10^8.
...
& $PythonBin `
  ...
  --run-root MLPS/tabular/shared/dae_dnn/results/parammatched_decade_v1_param_10pow07_08 `
