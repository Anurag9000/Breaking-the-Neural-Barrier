...
The candidate checkpoints, optimizer state, best state, and `phase_progress.csv` will be reused.
...
That is the only distinction that matters for the saved optimizer state and best checkpoint.
