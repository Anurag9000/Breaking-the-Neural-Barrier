...
from ..Models.dae_saltpepper_mlp_stl import DAESaltPepperMLP, dae_total_neurons
...
def main() -> None:
    p = argparse.ArgumentParser(description="Salt-and-pepper MLP DAE STL on CIFAR")
    p.add_argument("--dataset", type=str, default="cifar10", choices=["cifar10", "cifar100"])
    p.add_argument("--data_dir", type=str, default="./data")
    p.add_argument("--out_dir", type=str, default="./Runs/dae_saltpepper_mlp_stl")
