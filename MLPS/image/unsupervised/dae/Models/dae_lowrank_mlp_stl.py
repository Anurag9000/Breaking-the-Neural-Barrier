...
class DAELowRankMLP(nn.Module):
    """
    Fully-connected denoising autoencoder with a low-rank-style penalty on the
    encoder weights (via nuclear norm). Architecture is a standard MLP
    encoder/decoder.
    """
...
__all__ = ["DAELowRankMLP", "dae_total_neurons"]
