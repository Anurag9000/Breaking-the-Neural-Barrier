...
# - Heads: 4 (Pg, Qg, Va, Vm), depth-phase then width-phase with per-attempt rollback.
...
class ADP_ALT_DEPTH_4Head:
    """ADP_ALT_DEPTH forward-only for 4-head DEN (depth-phase then width-phase)."""
...
# - Heads: 4 (Pg, Qg, Va, Vm).
# - Implements ADP_ALT_DEPTH forward-only: depth-phase then width-phase; failed expansions are kept, global best restored only between phases/end.
