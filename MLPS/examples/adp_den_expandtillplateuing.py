...
# - Heads: 1 (single head) width-only with rollback and mixed patience; conflicts with forward-only spec.
# - Deviations: per-expansion rollback; early-stopping and expansion patience intertwined.
...
# - Heads: 1 (single head).
# - Implements ADP_WIDTH_ONLY forward-only; width_failure_count vs patience_width_exp and delta_width.
