...
# - Heads: 1 (single head) width-only with rollback; conflicts with forward-only spec.
# - Deviations: per-expansion rollback; mixed patience handling.
...
class ADP_DEN_4_head_width_only(nn.Module):
    """ADP_WIDTH_ONLY forward-only for 4-head MLP (Pg, Qg, Va, Vm)."""
