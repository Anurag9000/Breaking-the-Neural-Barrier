...
# - Heads: 4 (Pg, Qg, Va, Vm) depth-outer/width-inner with per-attempt rollback; conflicts with forward-only spec.
...
class ADPDepth_4Head(nn.Module):
    """ADP_DEPTH_OUTER_WIDTH_INNER with forward-only expansions (Pg, Qg, Va, Vm)."""
