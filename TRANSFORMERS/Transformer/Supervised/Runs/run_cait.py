...
def main():
    ...
    p.add_argument('--ca-blocks',type=int,default=2)
    ...
    p.add_argument('--save',default='CaiT_best.pth')
    a=p.parse_args()
    ...
    m=CaiT(img_size=a.img_size, num_classes=nc, dim=a.dim, depth=a.depth, heads=a.heads, ca_blocks=a.ca_blocks).to(dev)
