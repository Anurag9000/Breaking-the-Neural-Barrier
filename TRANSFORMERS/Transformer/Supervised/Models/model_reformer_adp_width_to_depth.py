...
# Load baseline
BASE_PATH = Path(__file__).with_name("model_reformer.py").resolve()
...
ModelClass = baseline_module.LocalLSHAttention

# ADP REVIEW (BEFORE REFACTOR)
# - This file is newly created to implement the ADP algorithms from scratch for the LocalLSHAttention model.
...
def rebuild_model(model: ModelClass, width: int, depth: int, device, cfg: ADPConfig) -> ModelClass:
    ...
    try:
        ...
        kwargs['bucket_size'] = get_attr(model, ['bucket_size'], 1)
