...
# Load baseline
BASE_PATH = Path(__file__).with_name("model_nest.py").resolve()
...
ModelClass = baseline_module.BlockMerge

# ADP REVIEW (BEFORE REFACTOR)
# - This file is newly created to implement the ADP algorithms from scratch for the BlockMerge model.
