...
# Load baseline
BASE_PATH = Path(__file__).with_name("model_informer.py").resolve()
...
ModelClass = baseline_module.ProbSparseAttention

# ADP REVIEW (BEFORE REFACTOR)
# - This file is newly created to implement the ADP algorithms from scratch for the ProbSparseAttention model.
...
def rebuild_model(model: ModelClass, width: int, depth: int, device, cfg: ADPConfig) -> ModelClass:
    ...
    try:
        ...
        kwargs['k_frac'] = get_attr(model, ['k_frac'], None)
