...
# Load baseline
BASE_PATH = Path(__file__).with_name("model_beit_sup.py").resolve()
...
ModelClass = baseline_module.BEiT_Sup

# ADP REVIEW (BEFORE REFACTOR)
# - This file is newly created to implement the ADP algorithms from scratch for the BEiT_Sup model.
