...
# Load baseline
BASE_PATH = Path(__file__).with_name("model_longformer_encoder.py").resolve()
...
ModelClass = baseline_module.LocalSelfAttention

# ADP REVIEW (BEFORE REFACTOR)
# - This file is newly created to implement the ADP algorithms from scratch for the LocalSelfAttention model.
...
def rebuild_model(model: ModelClass, width: int, depth: int, device, cfg: ADPConfig) -> ModelClass:
    ...
    try:
        ...
        kwargs['window'] = get_attr(model, ['window'], None)
