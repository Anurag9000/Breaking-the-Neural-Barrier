...
# Load baseline
BASE_PATH = Path(__file__).with_name("model_transformer_seq_2_seq.py").resolve()
...
ModelClass = baseline_module.SinusoidalPositionalEncoding

# ADP REVIEW (BEFORE REFACTOR)
# - This file is newly created to implement the ADP algorithms from scratch for the SinusoidalPositionalEncoding model.
