...
# Load baseline
BASE_PATH = Path(__file__).with_name("model_transformer_xl.py").resolve()
...
ModelClass = baseline_module.RelPosBias

# ADP REVIEW (BEFORE REFACTOR)
# - This file is newly created to implement the ADP algorithms from scratch for the RelPosBias model.
