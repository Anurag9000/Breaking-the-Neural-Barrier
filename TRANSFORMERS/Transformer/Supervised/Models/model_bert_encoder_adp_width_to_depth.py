...
# Load baseline
BASE_PATH = Path(__file__).with_name("model_bert_encoder.py").resolve()
...
ModelClass = baseline_module.LearnedPositionalEncoding

# ADP REVIEW (BEFORE REFACTOR)
# - This file is newly created to implement the ADP algorithms from scratch for the LearnedPositionalEncoding model.
