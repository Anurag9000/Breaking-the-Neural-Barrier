...
# Load baseline
BASE_PATH = Path(__file__).with_name("model_deit.py").resolve()
...
ModelClass = baseline_module.DeiT

# ADP REVIEW (BEFORE REFACTOR)
# - This file is newly created to implement the ADP algorithms from scratch for the DeiT model.
