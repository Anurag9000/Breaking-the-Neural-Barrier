...
# Load baseline
BASE_PATH = Path(__file__).with_name("model_patchtst.py").resolve()
...
ModelClass = baseline_module.PatchTST

# ADP REVIEW (BEFORE REFACTOR)
# - This file is newly created to implement the ADP algorithms from scratch for the PatchTST model.
