...
# Load baseline
BASE_PATH = Path(__file__).with_name("model_autoformer.py").resolve()
...
ModelClass = baseline_module.MovingAvg

# ADP REVIEW (BEFORE REFACTOR)
# - This file is newly created to implement the ADP algorithms from scratch for the MovingAvg model.
