...
# Load baseline
BASE_PATH = Path(__file__).with_name("model_performer.py").resolve()
...
ModelClass = baseline_module.LinearAttention

# ADP REVIEW (BEFORE REFACTOR)
# - This file is newly created to implement the ADP algorithms from scratch for the LinearAttention model.
...
def rebuild_model(model: ModelClass, width: int, depth: int, device, cfg: ADPConfig) -> ModelClass:
    ...
    try:
        ...
        kwargs['nb_features'] = get_attr(model, ['nb_features'], None)
