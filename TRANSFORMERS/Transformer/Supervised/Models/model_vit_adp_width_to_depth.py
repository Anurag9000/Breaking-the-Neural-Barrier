...
# Load baseline
BASE_PATH = Path(__file__).with_name("model_vit.py").resolve()
...
ModelClass = baseline_module.PatchEmbed

# ADP REVIEW (BEFORE REFACTOR)
# - This file is newly created to implement the ADP algorithms from scratch for the PatchEmbed model.
