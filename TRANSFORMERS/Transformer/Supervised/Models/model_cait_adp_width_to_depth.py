...
# Load baseline
BASE_PATH = Path(__file__).with_name("model_cait.py").resolve()
...
ModelClass = baseline_module.ClassAttentionBlock

# ADP REVIEW (BEFORE REFACTOR)
# - This file is newly created to implement the ADP algorithms from scratch for the ClassAttentionBlock model.
