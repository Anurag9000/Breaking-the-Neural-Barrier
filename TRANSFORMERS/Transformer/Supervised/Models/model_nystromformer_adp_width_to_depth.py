...
# Load baseline
BASE_PATH = Path(__file__).with_name("model_nystromformer.py").resolve()
...
ModelClass = baseline_module.NystromSelfAttn

# ADP REVIEW (BEFORE REFACTOR)
# - This file is newly created to implement the ADP algorithms from scratch for the NystromSelfAttn model.
...
def rebuild_model(model: ModelClass, width: int, depth: int, device, cfg: ADPConfig) -> ModelClass:
    ...
    try:
        ...
        kwargs['landmarks'] = get_attr(model, ['landmarks'], None)
