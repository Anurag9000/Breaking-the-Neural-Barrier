...
# Load baseline
BASE_PATH = Path(__file__).with_name("model_mobilevit_v_2.py").resolve()
...
ModelClass = baseline_module.MBConv

# ADP REVIEW (BEFORE REFACTOR)
# - This file is newly created to implement the ADP algorithms from scratch for the MBConv model.
...
def rebuild_model(model: ModelClass, width: int, depth: int, device, cfg: ADPConfig) -> ModelClass:
    ...
    try:
        ...
        kwargs['exp'] = get_attr(model, ['exp'], None)
