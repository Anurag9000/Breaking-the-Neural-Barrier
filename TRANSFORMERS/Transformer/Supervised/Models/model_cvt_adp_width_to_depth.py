...
# Load baseline
BASE_PATH = Path(__file__).with_name("model_cvt.py").resolve()
...
ModelClass = baseline_module.ConvProj

# ADP REVIEW (BEFORE REFACTOR)
# - This file is newly created to implement the ADP algorithms from scratch for the ConvProj model.
...
def rebuild_model(model: ModelClass, width: int, depth: int, device, cfg: ADPConfig) -> ModelClass:
    ...
    try:
        ...
        kwargs['padding'] = get_attr(model, ['padding'], None)
