...
# Load baseline
BASE_PATH = Path(__file__).with_name("model_pit.py").resolve()
...
ModelClass = baseline_module.TokenPool

# ADP REVIEW (BEFORE REFACTOR)
# - This file is newly created to implement the ADP algorithms from scratch for the TokenPool model.
...
def rebuild_model(model: ModelClass, width: int, depth: int, device, cfg: ADPConfig) -> ModelClass:
    ...
    try:
        ...
        kwargs['pool'] = get_attr(model, ['pool'], None)
