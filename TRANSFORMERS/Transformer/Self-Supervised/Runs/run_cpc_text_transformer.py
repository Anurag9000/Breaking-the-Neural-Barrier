...
from model_cpc_text_transformer import CPCTxtTransformer, SimpleTokenizer
...
class Config:
    ...
    out_dir: str = './outs_cpc_text_transformer'
    seed: int = 42
...
def train(cfg: Config):
    ...
    model = CPCTxtTransformer(len(tok.itos), cfg.dim, cfg.depth, cfg.heads, cfg.mlp_ratio, cfg.steps_ahead).to(cfg.device)
    ...
    save_plot(tr_curve, 'CPC-Text Train Loss', os.path.join(cfg.out_dir,'train_loss.png'), semilogy=True)
...
if __name__=='__main__':
    ...
    a.add_argument('--max_len', type=int, default=128)
    ...
    a.add_argument('--steps_ahead', type=int, default=3)
    ...
    a.add_argument('--out_dir', type=str, default='./outs_cpc_text_transformer')
