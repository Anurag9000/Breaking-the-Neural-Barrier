...
from model_gpt_lm import GPTLM
...
def train(cfg: Config):
    ...
    model = GPTLM(len(tok.itos), cfg.dim, cfg.depth, cfg.heads, cfg.mlp_ratio, cfg.max_len).to(cfg.device)
    ...
    save_plot(tr_curve, 'GPT LM Train Loss', os.path.join(cfg.out_dir,'train_loss.png'), semilogy=True)
...
if __name__=='__main__':
    ...
    a.add_argument('--out_dir', type=str, default='./outs_gpt_lm')
