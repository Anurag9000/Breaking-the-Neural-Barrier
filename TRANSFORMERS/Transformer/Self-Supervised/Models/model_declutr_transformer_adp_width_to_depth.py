...
# Load baseline
BASE_PATH = Path(__file__).with_name("model_declutr_transformer.py").resolve()
...
ModelClass = baseline_module.DeCLUTRTransformer

# ADP REVIEW (BEFORE REFACTOR)
# - This file is newly created to implement the ADP algorithms from scratch for the DeCLUTRTransformer model.
