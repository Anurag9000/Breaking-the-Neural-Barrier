...
# Load baseline
BASE_PATH = Path(__file__).with_name("model_vicreg_text_transformer.py").resolve()
...
ModelClass = baseline_module.VICRegTextTransformer

# ADP REVIEW (BEFORE REFACTOR)
# - This file is newly created to implement the ADP algorithms from scratch for the VICRegTextTransformer model.
