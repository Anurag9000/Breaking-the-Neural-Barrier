...
# Load baseline
BASE_PATH = Path(__file__).with_name("model_xlnet_perm_lm.py").resolve()
...
ModelClass = baseline_module.XLNetPermLM

# ADP REVIEW (BEFORE REFACTOR)
# - This file is newly created to implement the ADP algorithms from scratch for the XLNetPermLM model.
