...
# Load baseline
BASE_PATH = Path(__file__).with_name("model_hubert_single.py").resolve()
...
ModelClass = baseline_module.HuBERTSingle

# ADP REVIEW (BEFORE REFACTOR)
# - This file is newly created to implement the ADP algorithms from scratch for the HuBERTSingle model.
...
def rebuild_model(model: ModelClass, width: int, depth: int, device, cfg: ADPConfig) -> ModelClass:
    ...
    try:
        ...
        kwargs['feat_dim'] = get_attr(model, ['feat_dim'], 1)
