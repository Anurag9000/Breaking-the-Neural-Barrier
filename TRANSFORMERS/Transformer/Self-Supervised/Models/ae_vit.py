"""
Plain ViT Autoencoder (single-model)
- Encoder: ViT over all patches
- Decoder: MLP per token reconstructing pixels
- Loss: MSE over all patches
"""
