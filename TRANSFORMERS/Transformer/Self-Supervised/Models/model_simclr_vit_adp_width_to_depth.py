...
# Load baseline
BASE_PATH = Path(__file__).with_name("model_simclr_vit.py").resolve()
...
ModelClass = baseline_module.ViTEncoder

# ADP REVIEW (BEFORE REFACTOR)
# - This file is newly created to implement the ADP algorithms from scratch for the ViTEncoder model.
