...
# Load baseline
BASE_PATH = Path(__file__).with_name("model_barlow_vit.py").resolve()
...
ModelClass = baseline_module.BarlowTwinsViT

# ADP REVIEW (BEFORE REFACTOR)
# - This file is newly created to implement the ADP algorithms from scratch for the BarlowTwinsViT model.
...
def rebuild_model(model: ModelClass, width: int, depth: int, device, cfg: ADPConfig) -> ModelClass:
    ...
    try:
        ...
        kwargs['lambd'] = get_attr(model, ['lambd'], None)
