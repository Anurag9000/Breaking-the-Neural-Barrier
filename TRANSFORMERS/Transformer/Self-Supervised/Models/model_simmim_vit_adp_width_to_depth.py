...
# Load baseline
BASE_PATH = Path(__file__).with_name("model_simmim_vit.py").resolve()
...
ModelClass = baseline_module.SimMIMViT

# ADP REVIEW (BEFORE REFACTOR)
# - This file is newly created to implement the ADP algorithms from scratch for the SimMIMViT model.
