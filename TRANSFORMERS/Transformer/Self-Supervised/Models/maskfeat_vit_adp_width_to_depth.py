...
# Load baseline
BASE_PATH = Path(__file__).with_name("maskfeat_vit.py").resolve()
...
ModelClass = baseline_module.HOGFixed

# ADP REVIEW (BEFORE REFACTOR)
# - This file is newly created to implement the ADP algorithms from scratch for the HOGFixed model.
...
def rebuild_model(model: ModelClass, width: int, depth: int, device, cfg: ADPConfig) -> ModelClass:
    ...
    try:
        ...
        kwargs['bins'] = get_attr(model, ['bins'], None)
