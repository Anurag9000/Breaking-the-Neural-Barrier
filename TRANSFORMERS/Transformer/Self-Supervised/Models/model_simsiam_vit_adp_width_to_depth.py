...
# Load baseline
BASE_PATH = Path(__file__).with_name("model_simsiam_vit.py").resolve()
...
ModelClass = baseline_module.Predictor
from _common_real_image import make_real_image_loaders

# ADP REVIEW (BEFORE REFACTOR)
# - This file is newly created to implement the ADP algorithms from scratch for the Predictor model.
