...
# Load baseline
BASE_PATH = Path(__file__).with_name("model_gpt_lm.py").resolve()
...
ModelClass = baseline_module.CausalBlock

# ADP REVIEW (BEFORE REFACTOR)
# - This file is newly created to implement the ADP algorithms from scratch for the CausalBlock model.
