...
def make_real_transformer_smoke_loaders(
    ...
    *,
    ...
    if ds_name not in {'CIFAR10', 'CIFAR100'}:
        raise ValueError(f'Unsupported transformer smoke dataset: {dataset_name}')
    tf = transforms.Compose([transforms.ToTensor()])
    ds_cls = datasets.CIFAR10 if ds_name == 'CIFAR10' else datasets.CIFAR100
