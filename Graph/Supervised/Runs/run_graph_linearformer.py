...
from graph_linearformer import LinearGraphTransformer
...
def train(args):
    ...
    model = LinearGraphTransformer(dataset.num_features, dim=args.dim, out_dim=dataset.num_classes, layers=args.layers, heads=args.heads, dropout=args.dropout).to(args.device)
