...
from graph_graphbert import GraphBERTLike
...
def train(args):
    ...
    model = GraphBERTLike(dataset.num_features, dim=args.dim, out_dim=dataset.num_classes, layers=args.layers, heads=args.heads, max_nodes=args.max_nodes, dropout=args.dropout).to(args.device)
...
if __name__=='__main__':
    ...
    p.add_argument('--max_nodes', type=int, default=10000)
