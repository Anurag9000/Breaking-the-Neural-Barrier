...
def train(args):
    ...
    model = HANNet(dataset.num_features, hidden_dim=args.hidden_dim, out_dim=dataset.num_classes, heads=args.heads, layers=args.layers).to(args.device)
