...
from graph_exphormer import ExphormerLite
...
def train(args):
    ...
    model = ExphormerLite(dataset.num_features, dim=args.dim, out_dim=dataset.num_classes, layers=args.layers, heads=args.heads, dropout=args.dropout, extra_global=args.extra_global).to(args.device)
...
if __name__=='__main__':
    ...
    p.add_argument('--extra_global', type=int, default=16)
