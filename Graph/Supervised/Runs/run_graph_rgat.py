...
from graph_rgat import RGATNet
...
def train(args):
    ...
    model = RGATNet(dataset.num_features, args.hidden_dim, dataset.num_classes, args.num_layers, args.heads, args.num_relations, args.dropout).to(args.device)
...
if __name__=='__main__':
    ...
    p.add_argument('--num_relations', type=int, default=1)
