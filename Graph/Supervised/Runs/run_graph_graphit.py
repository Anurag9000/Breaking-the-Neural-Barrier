...
from graph_graphit import GraphiTLike
...
def train(args):
    ...
    model = GraphiTLike(dataset.num_features, dim=args.dim, out_dim=dataset.num_classes, layers=args.layers, heads=args.heads, rw_steps=args.rw_steps, dropout=args.dropout).to(args.device)
...
if __name__=='__main__':
    ...
    p.add_argument('--rw_steps', type=int, default=4)
