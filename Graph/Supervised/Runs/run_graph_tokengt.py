...
from graph_tokengt import TokenGTLike
...
def train(args):
    ...
    model = TokenGTLike(dataset.num_features, dim=args.dim, out_dim=dataset.num_classes, layers=args.layers, heads=args.heads, dropout=args.dropout).to(args.device)
