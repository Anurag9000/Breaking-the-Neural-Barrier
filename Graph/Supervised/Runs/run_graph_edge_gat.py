...
from graph_edge_gat import EdgeGATNet
...
def train(args):
    ...
    model = EdgeGATNet(dataset.num_features, args.hidden_dim, dataset.num_classes, args.heads, args.num_layers, args.dropout).to(args.device)
