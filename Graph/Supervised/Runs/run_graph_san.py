...
from graph_san import SANEncoder
...
def train(args):
    ...
    model = SANEncoder(dataset.num_features, dim=args.dim, out_dim=dataset.num_classes, layers=args.layers, heads=args.heads, pe_dim=args.pe_dim, dropout=args.dropout).to(args.device)
