...
from graph_deepgat import DeepGAT
...
def train(args):
    ...
    model = DeepGAT(dataset.num_features, args.hidden_dim, dataset.num_classes, args.num_layers, args.heads, args.dropout).to(args.device)
