...
from adp_gnn_attrmask import AttrMaskModel, TrainConfig, train_with_early_stop, evaluate_ssl, snapshot
...
class Config:
    ...
    dropout: float = 0.2
    seed: int = 42
    save_path: str = './checkpoints/attrmask_cora.pt'
...
def main():
    ...
    model = AttrMaskModel(in_dim, cfg.hidden, cfg.out_dim, cfg.num_layers, cfg.dropout)
    tcfg = TrainConfig()
