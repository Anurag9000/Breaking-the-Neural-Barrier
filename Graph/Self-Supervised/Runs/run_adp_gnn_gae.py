# Runner for GAE on Cora (Planetoid)
...
from adp_gnn_gae import GAE, TrainConfig, train_with_early_stop, evaluate_ssl, snapshot
...
class Config:
    ...
    dropout: float = 0.0
    seed: int = 42
    save_path: str = './checkpoints/gae_cora.pt'
...
def main():
    ...
    model = GAE(in_dim, cfg.hidden, cfg.out_dim, cfg.num_layers, cfg.dropout)
    tcfg = TrainConfig()
