# Runner for GRACE on Planetoid (Cora)
...
from adp_gnn_grace import GRACE, TrainConfig, train_with_early_stop, evaluate_ssl, snapshot
...
class Config:
    ...
    dropout: float = 0.2
    seed: int = 42
    save_path: str = './checkpoints/grace_cora.pt'
...
def main():
    ...
    model = GRACE(in_dim, cfg.hidden, cfg.out_dim, cfg.num_layers, cfg.dropout)
    tcfg = TrainConfig()
