# Runner for GraphMAE-Lite on Cora
...
from adp_gnn_graphmae_lite import GraphMAELite, TrainConfig, train_with_early_stop, evaluate_ssl, snapshot
...
class Config:
    ...
    dropout: float = 0.2
    seed: int = 42
    save_path: str = './checkpoints/graphmae_lite_cora.pt'
...
def main():
    ...
    model = GraphMAELite(in_dim, cfg.hidden, cfg.out_dim, cfg.num_layers, cfg.dropout)
    tcfg = TrainConfig()
