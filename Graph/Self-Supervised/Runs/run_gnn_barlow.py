# Runner for Barlow Twins (graph-level) on PROTEINS
...
from adp_gnn_barlow import BarlowG, TrainConfig, train_with_early_stop, evaluate_ssl, snapshot
...
class Config:
    ...
    batch_size: int = 64
    seed: int = 42
    save_path: str = './checkpoints/barlow_proteins.pt'
...
def main():
    ...
    model = BarlowG(in_dim, cfg.hidden, cfg.out_dim, cfg.proj_dim, cfg.num_layers, cfg.dropout)
    tcfg = TrainConfig()
