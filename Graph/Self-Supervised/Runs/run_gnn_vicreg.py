# Runner for VICReg-G on PROTEINS
...
from adp_gnn_vicreg import VICRegG, TrainConfig, train_with_early_stop, evaluate_ssl, snapshot
...
class Config:
    ...
    batch_size: int = 64
    seed: int = 42
    save_path: str = './checkpoints/vicreg_proteins.pt'
...
def main():
    ...
    model = VICRegG(in_dim, cfg.hidden, cfg.out_dim, cfg.proj_dim, cfg.num_layers, cfg.dropout)
    tcfg = TrainConfig()
