# Runner for VGAE on Cora (Planetoid)
...
from adp_gnn_vgae import VGAE, TrainConfig, train_with_early_stop, evaluate_ssl, snapshot
...
class Config:
    ...
    dropout: float = 0.0
    seed: int = 42
    save_path: str = './checkpoints/vgae_cora.pt'
...
def main():
    ...
    model = VGAE(in_dim, cfg.hidden, cfg.z_dim, cfg.num_layers, cfg.dropout)
    tcfg = TrainConfig()
