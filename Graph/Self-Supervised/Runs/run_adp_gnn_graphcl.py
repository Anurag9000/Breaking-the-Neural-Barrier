# Runner for GraphCL on TU datasets (e.g., PROTEINS)
...
from adp_gnn_graphcl import GraphCL, TrainConfig, train_with_early_stop, evaluate_ssl, snapshot
...
class Config:
    ...
    batch_size: int = 64
    seed: int = 42
    save_path: str = './checkpoints/graphcl_proteins.pt'
...
def main():
    ...
    model = GraphCL(in_dim, cfg.hidden, cfg.out_dim, cfg.proj_dim, cfg.num_layers, cfg.dropout)
    tcfg = TrainConfig()
