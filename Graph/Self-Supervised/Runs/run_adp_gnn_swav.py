...
from adp_gnn_swav import SwAV_G, TrainConfig, train_with_early_stop, evaluate_ssl, snapshot
...
class Config:
    ...
    batch_size: int = 64
    seed: int = 42
    save_path: str = './checkpoints/swav_proteins.pt'
...
def main():
    ...
    model = SwAV_G(in_dim, cfg.hidden, cfg.out_dim, cfg.proj_dim, cfg.num_prototypes, cfg.num_layers, cfg.dropout)
    tcfg = TrainConfig()
