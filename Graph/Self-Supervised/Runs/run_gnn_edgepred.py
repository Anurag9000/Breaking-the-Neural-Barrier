...
from adp_gnn_edgepred import EdgePred, TrainConfig, train_with_early_stop, evaluate_ssl, snapshot
...
class Config:
    ...
    dropout: float = 0.2
    seed: int = 42
    save_path: str = './checkpoints/edgepred_cora.pt'
...
def main():
    ...
    model = EdgePred(data.num_features, cfg.hidden, cfg.out_dim, cfg.num_layers, cfg.dropout)
    tcfg = TrainConfig()
