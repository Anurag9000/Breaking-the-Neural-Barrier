...
from models.pfgmpp_min import PFGMpp
...
p.add_argument('--save', type=str, default='./results/pfgmpp')
...
logger = ContinuousLogger(Path('results_run_pfgmpp'), 'run_pfgmpp', 'train')
...
with torch.no_grad():
    ...
    save_samples(grid, os.path.join(args.save, 'samples_pfgmpp.png'))

torch.save(model.state_dict(), os.path.join(args.save, 'pfgmpp.pth'))
