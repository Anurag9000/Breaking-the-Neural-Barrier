...
from models.rectified_flow_model import RectifiedFlow
...
p.add_argument('--save', type=str, default='./results/rf')
...
logger = ContinuousLogger(Path('results_run_rectified_flow'), 'run_rectified_flow', 'train')
...
with torch.no_grad():
    ...
    save_samples(grid, os.path.join(args.save, 'samples_rf.png'))

torch.save(model.state_dict(), os.path.join(args.save, 'rf.pth'))
