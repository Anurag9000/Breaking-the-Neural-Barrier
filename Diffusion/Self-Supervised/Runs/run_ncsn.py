...
from models.ncsn_model import NCSN
...
parser.add_argument('--save', type=str, default='./results/ncsn')
parser.add_argument('--steps_per_level', type=int, default=80)
...
logger = ContinuousLogger(Path('results_run_ncsn'), 'run_ncsn', 'train')
...
with torch.no_grad():
    ...
    save_samples(grid, os.path.join(args.save, 'samples_ncsn.png'))
    torch.save(model.state_dict(), os.path.join(args.save, 'ncsn.pth'))
