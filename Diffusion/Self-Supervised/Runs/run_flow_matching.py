...
p.add_argument('--save', type=str, default='./results/fm')
p.add_argument('--steps', type=int, default=50)
p.add_argument('--weight', type=str, default='uniform', choices=['uniform', 'speed'])
...
model = FlowMatching(weight=args.weight).to(device)
...
with torch.no_grad():
    ...
    save_samples(grid, os.path.join(args.save, 'samples_fm.png'))

torch.save(model.state_dict(), os.path.join(args.save, 'fm.pth'))
