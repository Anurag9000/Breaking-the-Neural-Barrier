...
def make_cifar10_loaders(data_root='./data', batch_size=128, val_ratio=0.1, num_workers=4):
    ...
    # ensure validation uses evaluation transform
...
class EarlyStopper:
    ...
    def step(self, val):
        """
        Call at each validation step. Returns True if improvement occurred.
        """
...
def save_samples(grid, path):
    """
    Save a grid of images to a given path.
    """
