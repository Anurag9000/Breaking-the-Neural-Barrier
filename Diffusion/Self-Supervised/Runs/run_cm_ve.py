...
from models.cm_ve import VEConsistency
...
p.add_argument('--save', type=str, default='./results/cm_ve')
...
logger = ContinuousLogger(Path('results_run_cm_ve'), 'run_cm_ve', 'train')
...
with torch.no_grad():
    ...
    save_samples(grid, os.path.join(args.save, 'samples_cm_ve.png'))
    torch.save(model.state_dict(), os.path.join(args.save, 'cm_ve.pth'))
