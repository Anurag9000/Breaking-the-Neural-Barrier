...
# Load baseline
BASE_PATH = Path(__file__).with_name("rectified_flow_model_py_single_model_rectified_flow_flow_matching.py").resolve()
_spec = importlib.util.spec_from_file_location("baseline_module", BASE_PATH)
baseline_module = importlib.util.module_from_spec(_spec)
_spec.loader.exec_module(baseline_module)
ModelClass = baseline_module.SinusoidalTimeEmbedding

# ADP REVIEW (BEFORE REFACTOR)
# - This file is newly created to implement the ADP algorithms from scratch for the SinusoidalTimeEmbedding model.
