# ============================================================
# File: run_adp_diff_vpred.py  (RUN)
# Unified runner for v-parameterized DDPM with 6 ADP policies
# ============================================================
...
from adp_diff_vpred import VPredDiffusionSingleModel, TrainCfg, SearchCfg, POLICIES
...
def main():
    p = argparse.ArgumentParser(description='v-parameterized DDPM with ADP (single model)')
    ...
    model = VPredDiffusionSingleModel(img_ch=3, widths=args.widths, T=args.T)
    ...
    print(f"[V-PRED] Finished. Best val loss = {best:.4f}. Final neurons = {model.neurons()}.")
