# ============================================================
# File: run_adp_diff_consistency.py  (RUN)
# Runner for single-model consistency diffusion with 6 ADP policies
# ============================================================
...
from adp_diff_consistency import ConsistencyDiffusionSingleModel, TrainCfg, SearchCfg, POLICIES
...
def main():
    p = argparse.ArgumentParser(description='Consistency Diffusion (single-model) with ADP')
    ...
    model = ConsistencyDiffusionSingleModel(img_ch=3, widths=args.widths, T=args.T,
    ...
    print(f"[CONSISTENCY] Finished. Best val loss = {best:.4f}. Final neurons = {model.neurons()}.")
...
# ============================================================
# End of run_adp_diff_consistency.py
# ============================================================
