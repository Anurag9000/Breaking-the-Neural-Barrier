# ============================================================
# File: run_adp_diff_flow.py  (RUN)
# Unified runner for Flow-Matching / Rectified Flow with 6 ADP policies
# ============================================================
...
from adp_diff_flow import FlowMatchingSingleModel, TrainCfg, SearchCfg, POLICIES
...
def main():
    p = argparse.ArgumentParser(description='Flow-Matching/Rectified-Flow with ADP (single model)')
    ...
    model = FlowMatchingSingleModel(img_ch=3, widths=args.widths)
    ...
    print(f"[FLOW] Finished. Best val loss = {best:.4f}. Final neurons = {model.neurons()}.")
