...
def random_rect_mask(x):
    ...
    for i in range(b):
        ...
        mask[i, :, top:top+rh, left:left+rw] = 0.0  # 0 -> unknown region to inpaint
    return mask
...
def train(cfg: TrainConfig):
    ...
    logger = ContinuousLogger(Path('results_run_ddpm_inpaint_unet'), 'run_ddpm_inpaint_unet', 'train')
    ...
    # sample: inpaint masks on test images
