...
from model_eva_sup import EVA_Sup
...
def main():
    ...
    p.add_argument('--save',default='EVA_Sup_best.pth')
    a=p.parse_args()
    ...
    m=EVA_Sup(img_size=a.img_size, num_classes=nc, dim=a.dim, depth=a.depth, heads=a.heads).to(dev)
