...
from ADP_MetaFormer_model import build_metaformer
...
def main():
    ...
    model = build_metaformer(num_classes=10, init_width=args.init_width, init_depth=args.init_depth, patch=args.patch)
