...
from ADP_RetNet_model import build_retnet, TrainCfg, ADPCfg, adp_search
...
def main():
    ...
    model = build_retnet(num_classes=10, init_width=args.init_width, init_depth=args.init_depth, patch=args.patch)
    ...
    # final test
    test_loss, test_acc = (lambda m: (m[0], m[1]))( __import__('ADP_RetNet_model').evaluate(model, test_loader, train_cfg.device) )
