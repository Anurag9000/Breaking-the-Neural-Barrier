...
from ADP_TabTransformer_model import build_tabtransformer
...
def main():
    ...
    model = build_tabtransformer(num_classes=10, init_width=args.init_width, init_depth=args.init_depth, patch=args.patch)
