...
from ADP_DETRlite_model import build_detrlite
...
def main():
    ...
    model = build_detrlite(num_classes=10, init_width=args.init_width, init_depth=args.init_depth, patch=args.patch)
