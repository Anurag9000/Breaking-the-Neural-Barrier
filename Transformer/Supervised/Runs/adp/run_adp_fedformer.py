...
from ADP_FEDformer_model import build_fedformer
...
def main():
    ...
    model = build_fedformer(num_classes=10, init_width=args.init_width, init_depth=args.init_depth, topk=args.topk)
