...
from ADP_Graphormer_model import build_graphormer
...
def main():
    ...
    model = build_graphormer(num_classes=10, init_width=args.init_width, init_depth=args.init_depth, patch=args.patch)
