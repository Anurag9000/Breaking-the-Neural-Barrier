...
from ADP_PatchTST_model import build_patchtst
...
def main():
    ...
    model = build_patchtst(num_classes=10, init_width=args.init_width, init_depth=args.init_depth, patch_len=args.patch_len, img_h=32)
