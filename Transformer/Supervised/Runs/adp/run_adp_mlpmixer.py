...
from ADP_MLPMixer_model import build_mlp_mixer
...
def main():
    ...
    model = build_mlp_mixer(num_classes=10, init_width=args.init_width, init_depth=args.init_depth, patch=args.patch, image_size=32)
