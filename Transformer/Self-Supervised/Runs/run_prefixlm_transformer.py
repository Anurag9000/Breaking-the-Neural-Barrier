...
from model_prefixlm_transformer import PrefixLM
...
class Config:
    ...
    out_dir: str = './outs_prefixlm_transformer'
    seed: int = 42
...
def train(cfg: Config):
    ...
    model = PrefixLM(len(tok.itos), cfg.dim, cfg.depth, cfg.heads, cfg.mlp_ratio, cfg.max_len).to(cfg.device)
    ...
    save_plot(tr_curve, 'PrefixLM Train Loss', os.path.join(cfg.out_dir,'train_loss.png'), semilogy=True)
...
if __name__=='__main__':
    ...
    a.add_argument('--prefix_len', type=int, default=32)
    ...
    a.add_argument('--out_dir', type=str, default='./outs_prefixlm_transformer')
