...
from model_bart_denoise import BARTDenoise
...
def train(cfg: Config):
    ...
    model = BARTDenoise(len(tok.itos), cfg.dim, cfg.enc_depth, cfg.dec_depth, cfg.heads, cfg.mlp_ratio, cfg.max_len).to(cfg.device)
    ...
    save_plot(tr_curve, 'BART Denoise Train Loss', os.path.join(cfg.out_dir,'train_loss.png'), semilogy=True)
...
if __name__=='__main__':
    ...
    a.add_argument('--out_dir', type=str, default='./outs_bart_denoise')
