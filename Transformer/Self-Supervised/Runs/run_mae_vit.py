...
def train_mae(cfg: Config):
    ...
    with open(os.path.join(cfg.out_dir, "summary.json"), "w") as f:
        json.dump({"best_val": float(best_val), "test_loss": float(te_loss)}, f, indent=2)
...
if __name__ == "__main__":
    ...
    p.add_argument("--dec_embed_dim", type=int, default=192)
    ...
    p.add_argument("--out_dir", type=str, default="./outs_mae_vit")
