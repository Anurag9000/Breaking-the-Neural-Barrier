...
# - Heads: 2 (PQ, VM), depth-phase then width-phase with per-attempt rollback.
...
class MLPAlt2Head(nn.Module):
    """Shared input, two branch stacks (PQ, VM) and heads."""
...
class ADP_ALT_DEPTH_2Head:
    """ADP_ALT_DEPTH forward-only for 2-head DEN."""
