...
from adp_nlp_ssl_depth import AdaptiveTextSSL, adp_search_depth_then_width
...
def main():
    ...
    best = adp_search_depth_then_width(model, trl, val, device,
    ...
    path = os.path.join("checkpoints", "adp_nlp_ssl_depth.pt")
