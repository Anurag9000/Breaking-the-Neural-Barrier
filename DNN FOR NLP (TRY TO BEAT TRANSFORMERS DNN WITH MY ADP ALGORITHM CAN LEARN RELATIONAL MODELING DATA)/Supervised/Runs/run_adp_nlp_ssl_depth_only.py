...
from adp_nlp_ssl_depth_only import AdaptiveTextSSL, adp_search_depth_only
...
def main():
    ...
    best = adp_search_depth_only(model, trl, val, device,
                                 trials_depth=args.trials_depth,
                                 epochs=args.epochs, lr=args.lr, patience=args.patience,
                                 delta=args.delta, temperature=args.temperature,
                                 max_neurons=args.max_neurons, max_depth=args.max_depth, max_width=args.max_width)

    os.makedirs("checkpoints", exist_ok=True)
    path = os.path.join("checkpoints", "adp_nlp_ssl_depth_only.pt")
