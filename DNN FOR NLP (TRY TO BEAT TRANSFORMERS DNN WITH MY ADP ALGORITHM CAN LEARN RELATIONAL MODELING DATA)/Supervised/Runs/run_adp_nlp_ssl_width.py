...
from adp_nlp_ssl_width import AdaptiveTextSSL, adp_search_width_then_depth
...
def main():
    ...
    best = adp_search_width_then_depth(model, trl, val, device,
    ...
    path = os.path.join("checkpoints", "adp_nlp_ssl_width.pt")
