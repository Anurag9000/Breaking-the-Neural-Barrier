...
from adp_nlp_ssl_alt_width import AdaptiveTextSSL, adp_search_alternating_width_first
...
def main():
    ...
    best = adp_search_alternating_width_first(model, trl, val, device,
                                              cycles=args.cycles, w_steps=args.w_steps, d_steps=args.d_steps,
    ...
    path = os.path.join("checkpoints", "adp_nlp_ssl_alt_width.pt")
